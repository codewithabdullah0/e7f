...
import handleimg from '../Images/Group 1000008940.png'
import pointimg1 from '../Images/Group 1000008468 (2).svg'
import pointimg2 from '../Images/Group 1000008470.svg'
import pointimg3 from '../Images/Group 1000008470.svg'
import pointimg4 from '../Images/Group 1000008431.svg'
import pointimg5 from '../Images/Layer 3.svg'
import pointimg6 from '../Images/Group 1000008429.svg'
import pointimg7 from '../Images/Vector (5).png'
import pointimg8 from '../Images/Group 1000008432 (1).svg'
import pointimg9 from '../Images/Clip path group.svg'
import pointimg10 from '../Images/Group 1000008779.svg'
import pointimg11 from '../Images/Group 1000008434.svg'
import pointimg12 from '../Images/Group 1000008436.svg'
...
function Service() {
    return (
        <div>
                        ...
                        <div className="col-lg-7 col-12">
                            <Fade left duration={1500} distance='10%'>
                                ...
                                <h1 className="profile-text1" id="profile-text1">
                                    <span className="profile-text1-span2">E7figure </span>
                                    Digital Is Your <br className='d-md-block d-none' /> Amazon {' '}
                                    <span className="profile-text1-span2">Growth </span> <br className='d-md-block d-none' />
                                    Marketing
                                    <span className="profile-text1-span2"> Partner</span>
                                </h1>
                                <p className="home-banner-para1">
                                    You don’t need a new Amazon PPC agency. You need a partner  <br className="d-md-block d-none" /> with a proven track record of growing  <br className="d-md-block d-none" />
                                    brands profitably.
            ...
            <div className='container-fluid service-handle-div1'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-lg-5'>
                            <div className='service-handle-div2'>
                                <Fade bottom duration={1500} distance='3%'>
                                    <h1>Yep, we’ve got that
                                        handled too</h1>
                                </Fade>
                                <Fade bottom duration={1500} distance='3%'>
                                    <p>To us you’re not just a client. You’re a Partner. Let’s give your business room to grow with our suite of full-service
                                        solutions.</p>
                                </Fade>
                                <Fade bottom duration={1500} distance='3%'>
                                    <div className="home-btn-div1 d-flex align-items-center">
                        ...
                        <div className='col-lg-7 position-relative'>
                            <Fade bottom duration={1500} distance='3%'>
                                <div>
                                    <img src={handleimg} className='img-fluid service-handle-img1' alt="" />
                                </div>
                            </Fade>
                        </div>
                    </div>
            ...
            <div className='container-fluid services-point-div1'>
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-lg-6'>
                            <Fade bottom duration={1500} >
                                <div className='services-point-div2'>
                                    <div>
                                        <div className='services-point-imgdiv1'>
                                            <img src={pointimg1} alt="" />
                                        </div>
                                    </div>

                                    <div>
                                        <div className='services-point-textdiv1'>
                                            <h2>Growth planning & strategy</h2>
                                            <p>Whatever you want to achieve, we’ll get you there
                                                through meticulous planning and unmatched execution</p>
                                        </div>
                                    </div>
                                </div>
                            </Fade>
                                ...
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            ...
                                            <p>Want more sales? Better profitability? Our Amazon
                                                PPC experts use the latest technology to optimize
                                                campaigns for your specific needs</p>
                                        </div>
                                    </div>
                                </div>
                            </Fade>
                                ...
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            ...
                                            <p>Create high-converting product listings that lower ad
                                                costs, improve ranking and searchability, and grow
                                                sales</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className='col-lg-6'>
                            <Fade bottom duration={1500} >
                                <div className='services-point-div2'>
                                    <div>
                                        <div className='services-point-imgdiv1'>
                                            <img src={pointimg4} alt="" />
                                        </div>
                                    </div>

                                    <div>
                                        <div className='services-point-textdiv1'>
                                            <h2>Demand-Side Platform (DSP)</h2>
                                            <p>Reach your audience anywhere online to expand
                                                visibility and build brand loyalty with Amazon’s
                                                powerful programmatic advertising platform</p>
                                        </div>
                                    </div>
                                </div>
                            </Fade>
                        ...
                        <div className='col-lg-6'>
                            <Fade bottom duration={1500} >
                                <div className='services-point-div2'>
                                    <div>
                                        <div className='services-point-imgdiv1'>
                                            <img src={pointimg5} alt="" />
                                        </div>
                                    </div>

                                    <div>
                                        <div className='services-point-textdiv1'>
                                            <h2>Amazon brand support</h2>
                                            <p>Our Partner Success team handles all potential issues
                                                with your account health, including suppressed listings,
                                                stranded inventory, and more</p>
                                        </div>
                                    </div>
                                </div>
                            </Fade>
                                ...
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            ...
                                            <p>Never worry about restocking issues or forecasting
                                                issues again thanks to our time-tested inventory
                                ...
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            ...
                                            <p>Get your brand in front of shoppers on the world’s
                                                largest search engine with our targeted Google
                                ...
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            ...
                                            <p>Save valuable time on buyer-seller messaging, review
                                                management, and more through our full suite of
                                                customer service management options</p>
                                        </div>
                                    </div>
                                </div>
                            </Fade>
                        ...
                        <div className='col-lg-6'>
                            <Fade bottom duration={1500} >
                                <div className='services-point-div2'>
                                    <div>
                                        <div className='services-point-imgdiv1'>
                                            <img src={pointimg9} alt="" />
                                        </div>
                                    </div>

                                    <div>
                                        <div className='services-point-textdiv1'>
                                            <h2>Lost inventory recovery</h2>
                                            <p>Our proprietary recovery process hunts down every
                                                cent that you’re owed, so you can stay focused on the
                                                rest of your business</p>
                                        </div>
                                    </div>
                                </div>
                            </Fade>
                            ...
                            <Fade bottom duration={1500} >
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            <h2>Amazon SEO</h2>
                                            <p>We help you generate laser-targeted traffic and higher
                                                conversion rates, taking your sales velocity to the next
                                                level</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            ...
                                            <p>Convert shoppers into buyers and make your products
                                                shine with beautiful, professionally shot video and
                                                photography</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='services-point-div2'>
                                    ...
                                    <div>
                                        <div className='services-point-textdiv1'>
                                            ...
                                            <p>Keep a close eye on the data that matters most to you
                                                via our custom-built reporting tools and easy-to-
                                                understand dashboard</p>
                                        </div>
                                    </div>
                                </div>
                            </Fade>
