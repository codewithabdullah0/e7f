...
import './About.css'
import aboutsec3img from '../Images/Group 1000008937.png'
import meetpic1 from '../Images/Meet-Your-New-Partners 1.jpg'
import approchimg1 from '../Images/Group 1000008886.png'
...
function About() {
    return (
        <div>
                        ...
                        <div className="col-lg-7 col-12">
                            <Fade left duration={1500} distance='10%'>
                                ...
                                <h1 className="profile-text1" id="profile-text1">
                                    Former{' '}
                                    <span className="profile-text1-span2">Amazon Experts </span>
                                    Empowering Brands on{' '}
                                    <span className="profile-text1-span2"> Global </span>
                                    Marketplaces
                                </h1>
                                <p className="home-banner-para1">
                                    Built by Amazon sellers for Amazon Sellers. Our team includes <br className='d-md-block d-none' /> multi-million dollarsellers, award-winning experts, former <br className='d-md-block d-none' /> Amazonians, and accreditedecommerce professionals.
                                </p>
            ...
            <div className='container-fluid about-sec3-div1'>
                <div className='container'>
                    <Fade bottom duration={1500} distance='4%'>
                        <div className=''>
                            <img src={aboutsec3img} className='img-fluid' />
                        </div>
                    </Fade>
                </div>
            </div>
            ...
            <div className='container-fluid about-meet-div1'>
                <div className='container'>
                    <div className='about-meet-div2'>
                        <Fade bottom duration={1500} distance='4%'>
                            <h1>Meet your new partners</h1>
                        </Fade>
                        <Fade bottom duration={1500} distance='4%'>
                            <p>When you’re with E7Figures, you’re more than a client. You’re a partner.</p>
                        </Fade>
                        <Fade bottom duration={1500} distance='4%'>
                            <img src={meetpic1} className='img-fluid' alt="" />
                        </Fade>
                    </div>
                </div>
            </div>
            ...
            <div className='container-fluid about-approch-div1'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-lg-5 d-flex align-items-center'>
                            <Fade left duration={1500} distance='6%'>
                                <div className='about-approch-div2'>
                                    <h1>Our Operational <br />
                                        <span>Approach</span></h1>
                                    <p>Our operational approach is guided by efficiency, collaboration, and innovation. We prioritize streamlined processes and clear communication to ensure seamless execution of projects. By fostering a culture of continuous improvement, we adapt to changing needs and deliver exceptional results to our clients.
                                    </p>
                                </div>
                            </Fade>
                        </div>
                        <div className='col-lg-7'>
                            <Fade right duration={1500} distance='6%'>
                                <div>
                                    <img src={approchimg1} className='img-fluid' alt="" />
                                </div>
                            </Fade>
                        </div>
                    </div>
