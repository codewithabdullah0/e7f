...
import ebcimg1 from '../Images/Group 1000008926.png'
...
import creativeimg1 from '../Images/Group 1000008929.svg'
import creativeimg2 from '../Images/Group 1000008928.svg'
import creativeimg3 from '../Images/Group 1000008930.svg'

import listingimg1 from '../Images/Group 1000008943.png'
import listingimg2 from '../Images/Group 1000008941.png'
import listingimg3 from '../Images/Group 1000008942.png'
...
function EBC() {
    return (
        <div>
                    ...
                    <div className="row h-100">
                        ...
                        <div className="col-lg-6 col-12 my-auto">
                            <Fade left duration={1500} distance='10%'>
                                <p className="home-banner-p121 for-mobile-home-banner-p121">
                                    <svg
                                ...
                                <h1 className="profile-text1 for-mobile-profile-text1" id="profile-text1">
                                    <span className="profile-text1-span2">EBC / A+</span> <br />
                                    Store Creation
                                </h1>

                                <p className="home-banner-para1 for-mobile-home-banner-para1">
                                    {" "}
                        ...
                        <div className="col-lg-6 col-12 d-lg-flex d-none align-items-center h-100">
                            <Fade right duration={1500} distance='10%'>
                                <div className="">
                                    <img
                                        src={ebcimg1}
                        ...
                        <div className="image-sec-text2">
                            <div className="row">
                                <div className="col-md-4 col-12">
                                    <div>
                                        <div className="image-listing-img112">
                                            <img src={creativeimg1} alt="" />
                                        </div>
                                        <h1 className="images-listing-text1">Enhanced Visibility</h1>
                                        <p className="images-listing-text2">The customers only sees what  <br className="d-md-block d-none" /> you show them.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-4 col-12">
                                    <div>
                                        ...
                                        <p className="images-listing-text2">The customer’s perception is:
                                            <br className="d-md-block d-none" />  bad product image = bad product</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-4 col-12">
                                    <div>
                                        <div className="image-listing-img112">
                                            <img src={creativeimg3} alt="" />
                                        </div>
                                        <h1 className="images-listing-text1">Conversion Power</h1>
                                        <p className="images-listing-text2">Images account for around 75%  <br className="d-md-block d-none" />
            ...
            <div className="container-fluid amazon-home-whitesec-div3">
                <div className="container">

                    <div className='row listing-img-text-div1'>

                        <div className='col-lg-6 col-12 d-lg-flex d-none align-items-center justify-content-center'>
                            <div>
                        ...
                        <div className="col-lg-6 col-12">
                            <div>
                                <h1 className='listing-img-whitetext12'>A+/EBC Content</h1>
                                <p className='listing-img-whitetext22'>A+ Content Design  will help you elevate your Amazon listings, making them visually engaging and information-rich. With our help, you can highlight the unique features of your product and tell your brand’s story in a compelling way</p>
                                <ul className="images-ul-whitetext1">
                ...
                <div className="container">
                    ...
                    <div className='row listing-img-text-div1'>
                        ...
                        <div className='col-lg-6 col-12 d-flex align-items-center justify-content-center'>
                            <div className=' '>
                                <img src={listingimg3} alt="" className="img-fluid" />
                            </div>
                        </div>
                    </div>
